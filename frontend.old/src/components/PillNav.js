...
const PillNav = ({
  ...
  return (
    <div className="pill-nav-wrapper">
        ...
        <div ref={navItemsRef} className="pill-nav-items">
          <ul role="menubar" className="pill-nav-list">
            {items.map((item, i) => {
              ...
              return (
                <li key={item.href} role="none" className="pill-nav-item">
      ...
      <div ref={mobileMenuRef} className="pill-nav-mobile-menu" style={cssVars}>
        <ul className="pill-nav-mobile-list">
          {items.map(item => {
            const linkClasses = 'pill-nav-mobile-link';
